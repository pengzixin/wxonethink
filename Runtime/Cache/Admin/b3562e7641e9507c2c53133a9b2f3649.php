...
<body>
	...
	<form action="<?php echo U('');?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">电话<span class="check-tips">（请填写正确的电话号码，已方便联系）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="tel" value="<?php echo ((isset($info["tel"]) && ($info["tel"] !== ""))?($info["tel"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">详细地址<span class="check-tips">（详细地址，方便上门修理）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="address" value="<?php echo ((isset($info["address"]) && ($info["address"] !== ""))?($info["address"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">问题<span class="check-tips">（描述你遇到问题）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="trouble" value="<?php echo ((isset($info["trouble"]) && ($info["trouble"] !== ""))?($info["trouble"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
